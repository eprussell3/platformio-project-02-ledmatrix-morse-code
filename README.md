...
using Pin 5 and GND pin on the DIGITAL PWM connector (see schematic)
...
4. The entire project was written using MS Visual Code with the PlatformIO extension (not the Arduino IDE) so there may be some minor code modifications required if you are using the IDE
